  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader
          ...
          action={
            <span className="text-sm text-slate-600">
              {active.length} upcoming · {items.length} total
            </span>
          }
        />
        ...
        {failure ? (
          <div className="mb-4">
            <Alert tone="error" title="That action did not go through">
        ...
        <QueryState
          ...
          emptyMessage="No appointments today. Enjoy the quiet."
        >
          ...
          {resolved.length > 0 ? (
            <div className="mt-6">
              <h3 className="mb-3 text-sm font-medium text-slate-500">Finished today</h3>
